...
class UrgencyField extends AbstractConfigField
{
    ...
    public function renderConfigForm(
        ...
        return $twig->render('pages/admin/form/itil_config_fields/urgency.html.twig', [
            ...
            'specific_value_extra_field' => [
                ...
                'input_name'      => $input_name . "[" . UrgencyFieldConfig::URGENCY . "]",
            ...
            'specific_answer_extra_field' => [
                ...
                'input_name'      => $input_name . "[" . UrgencyFieldConfig::QUESTION_ID . "]",
    ...
    public function applyConfiguratedValueToInputUsingAnswers(
        ...
        $urgency = $config->getStrategy()->getUrgency($config, $answers_set);
