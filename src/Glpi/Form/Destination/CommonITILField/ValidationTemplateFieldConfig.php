...
final class ValidationTemplateFieldConfig implements JsonFieldInterface
{
    ...
    public function __construct(
        private ValidationTemplateFieldStrategy $strategy,
    ...
    {
        $strategy = ValidationTemplateFieldStrategy::tryFrom($data[self::STRATEGY] ?? "");
        if ($strategy === null) {
    ...
    public function getStrategy(): ValidationTemplateFieldStrategy
    {
