...
final class QuestionTypeLocation extends AbstractQuestionType
{
    /**
     * Retrieve the default value for the location question type
     *
    ...
    public function renderAnswerTemplate($answer): string
    {
        $template = <<<TWIG
            <div class="form-control-plaintext">
                {{ get_item_link('Location', itil_category_id) }}
            </div>
TWIG;
    ...
    {
        return QuestionTypeCategory::LOCATION;
    }
