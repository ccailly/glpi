...
final class QuestionTypeITILCategory extends AbstractQuestionType
{
    /**
     * Ret rieve the default value for the request type question type
     *
...
TWIG;
        ...
        return $twig->renderFromStringTemplate($template, [
            'value'           => $this->getDefaultValue($question),
            'question'        => $question,
            'itil_categories' => Ticket::getTypes(),
    ...
    public function renderAnswerTemplate($answer): string
    {
        $template = <<<TWIG
            <div class="form-control-plaintext">
                {{ get_item_link('ITILCategory', itil_category_id) }}
            </div>
TWIG;

        $twig = TemplateRenderer::getInstance();
        return $twig->renderFromStringTemplate($template, [
            'itil_category_id' => $answer,
        ]);
    }
    ...
    {
        return QuestionTypeCategory::ITIL_CATEGORY;
    }
