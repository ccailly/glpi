...
--
-- Table structure for table `glpi_plugin_fields_pluginformcreatorcategorydsadadads`
--

DROP TABLE IF EXISTS `glpi_plugin_fields_pluginformcreatorcategorydsadadads`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `glpi_plugin_fields_pluginformcreatorcategorydsadadads` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `items_id` int unsigned NOT NULL,
  `itemtype` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT 'PluginFormcreatorCategory',
  `plugin_fields_containers_id` int unsigned NOT NULL DEFAULT '2',
  PRIMARY KEY (`id`),
...
--
-- Dumping data for table `glpi_plugin_fields_pluginformcreatorcategorydsadadads`
--

LOCK TABLES `glpi_plugin_fields_pluginformcreatorcategorydsadadads` WRITE;
/*!40000 ALTER TABLE `glpi_plugin_fields_pluginformcreatorcategorydsadadads` DISABLE KEYS */;
/*!40000 ALTER TABLE `glpi_plugin_fields_pluginformcreatorcategorydsadadads` ENABLE KEYS */;
UNLOCK TABLES;
