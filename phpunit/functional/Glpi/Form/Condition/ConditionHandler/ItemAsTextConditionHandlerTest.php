...
final class ItemAsTextConditionHandlerTest extends AbstractConditionHandler
{
    ...
    public static function conditionHandlerProvider(): iterable
    {
        ...
        // Test item answers with the NOT_MATCH_REGEX operator
